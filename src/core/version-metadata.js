export const APP_VERSION='V5.0.2-A2';
export const APP_BUILD='FACTURACION_REGISTRY_READ_ONLY_EXCEL_ACCESS';
...
export const APP_BUILD_LABEL='Multi-PC Enterprise · Facturación: Registro de Muestras solo lectura + Excel';
