...
export class FirebaseCloudAdapter extends CloudAdapter{
  constructor(config=null){
    super();this.config=normalizeFirebaseConfig(config||loadFirebaseConfig());this.app=null;this.db=null;this.sdk=null;this.connected=false;this.lastError=null;this.connectedAt=null;this.connectPromise=null;const savedConnection=localStorage.getItem(CONNECTION_PERSIST_KEY);this.desiredConnected=savedConnection==='1'||(savedConnection===null&&firebaseConfigComplete(this.config));
  }
